...
def build(build_name, output_root_directory, git_repository, git_commitish):
    ...
    with vm_manager(vm_names):
        build_irods_on_vms(ip_addresses, output_root_directory, git_repository, git_commitish)
...
def build_irods_on_vms(ip_addresses, output_root_directory, git_repository, git_commitish):
...
if __name__ == '__main__':
    ...
    build(args.build_name, args.output_root_directory, args.git_repository, args.git_commitish)
